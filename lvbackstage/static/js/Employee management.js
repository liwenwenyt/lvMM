$(function(){
	$("#menuT").click(function(){
		if($("#menuM").css("display")=="block"){
			$(".menu_top img").attr("src","img/icon1.png");
		}else{
			$(".menu_top img").attr("src","img/icon2.png");
		}
		$("#menuM").slideToggle();
	})
	$("#menuT1").click(function(){
		if($("#menuM1").css("display")=="block"){
			$(".menu_top1 img").attr("src","img/icon1.png");
		}else{
			$(".menu_top1 img").attr("src","img/icon2.png");
		}
		$("#menuM1").slideToggle();
	})
	$("#menuT2").click(function(){
		if($("#menuM2").css("display")=="block"){
			$(".menu_top2 img").attr("src","img/icon1.png");
			$("#menuT2").css("borderRadius","0 0 5px 5px");
		}else{
			$(".menu_top2 img").attr("src","img/icon2.png");
			$("#menuT2").css("borderRadius","0");
		}
		$("#menuM2").slideToggle();
	})
	$("#menuT3").click(function(){
		if($("#menuM3").css("display")=="block"){
			$(".menu_top3 img").attr("src","img/icon1.png");
			$("#menuT3").css("borderRadius","0 0 5px 5px");
		}else{
			$(".menu_top3 img").attr("src","img/icon2.png");
			$("#menuT3").css("borderRadius","0");
		}
		$("#menuM3").slideToggle();
	})
	$("#menuT4").click(function(){
		if($("#menuM4").css("display")=="block"){
			$(".menu_top4 img").attr("src","img/icon1.png");
			$("#menuT4").css("borderRadius","0 0 5px 5px");
		}else{
			$(".menu_top4 img").attr("src","img/icon2.png");
			$("#menuT4").css("borderRadius","0");
		}
		$("#menuM4").slideToggle();
	})
})
...
function checkAll(type,value){
	var reg = null;
	switch(type){
		case "userid":reg = /^[0-9]\d{5}$/;break;
		case "userphone":reg = /^1[^0126]\d{9}$/;break;
		case "useridcard":reg = /^[1-9]\d{5}(19|20)\d{2}(0[1-9]|[0-2])(0[1-9]|1[0-9]|2[0-9]|3[0-1])\d{3}[0-9xX]$/;break;
		default:;
	}
	if(reg!=null){
		if(reg.test(value)){
...
$(function(){
	$("#textId").blur(function(){
		if(checkAll("userid",this.value)==false){
			$("#textId").css("border","1px solid #fc3f83");
		}else{
			$("#textId").css("border","1px solid #3ffc6b");
		}
	});
})
...
function deleteRow(){
	if(confirm("亲，您真的要删除吗？")==true){
		...
		trDom.parentNode.remove(trDom);	
	}
}
$(function(){
	$(".zsgc a:nth-child(3)").click(function(){
		if(confirm("亲，您真的要删除吗？")==true){
			var trDom  = this.parentNode.parentNode;
			trDom.parentNode.remove(trDom);	
		}
...
$(function(){
	...
	function backFun(){
		...
		var card= document.getElementById("textCard").value;
		//所在地
		var pos1= document.getElementById("cmbProvince").value;
		var pos2= document.getElementById("cmbCity").value;
		var pos3= document.getElementById("cmbArea").value;
		
		var bumen= document.getElementById("textBumen").value;
		//时间
		var time1= document.getElementById("textTime1").value;
		var time2= document.getElementById("textTime2").value;
		var time3= document.getElementById("textTime3").value;
		
		//2)、给表格创建行和列
		var tableDom  = document.getElementById("trmain");
		var rowDom = tableDom.insertRow();
		
		var idCellDom = rowDom.insertCell();
		var inputDom = document.createElement("input");
		inputDom.setAttribute("type","checkbox");
		inputDom.style.cssText = "position:absolute;top:7px;left:15px;";
		idCellDom.style.cssText = "position:relative;padding-left:25px";
		idCellDom.innerHTML = id;
		idCellDom.appendChild(inputDom);
		
		var nameCellDom = rowDom.insertCell();
		nameCellDom.innerHTML = name;
		
		var phoneCellDom = rowDom.insertCell();
		phoneCellDom.innerHTML = phone;
		
		var cardCellDom = rowDom.insertCell();
		cardCellDom.innerHTML = card;
		
		var posCellDom = rowDom.insertCell();
		var postDom = [pos1,pos2,pos3];
		var strDom = postDom.join();
		var strNew = strDom.replace(/,/ig," ");
		posCellDom.innerHTML =strNew;
		
		
		var bumenCellDom = rowDom.insertCell();
		bumenCellDom.innerHTML = bumen;
		
		var timeCellDom = rowDom.insertCell();
		var timeDom = [time1,time2,time3];
		var strDom1 = timeDom.join();
		var strNew1 = strDom1.replace(/,/ig,"/");
		timeCellDom.innerHTML = strNew1;
		
		var caozuoCellDom = rowDom.insertCell();
		var a1Dom = document.getElementById("qwer");
		//caozuoCellDom.appendChild(a1Dom);
		
		var str1 = `<div class="zsgc">
		<a href="#">
			<img src="img/sunchankan.png"/>
			<span>查看</span>
		</a>
		<a href="#">
			<img src="img/sunxiugai.png"/>
			<span>修改</span>
		</a>
		<a href="#" onclick="deleteRow()">
			<img src="img/sunshanchu.png"/>
			<span>删除</span>
		</a>
	</div>`;
		caozuoCellDom.innerHTML = str1;
	}
})
...
$(function(){
	...
	$('.checkgoods').click(function(){
		...
		}else if($('.checkgoods').prop('checked',false)){
